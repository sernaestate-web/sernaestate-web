...
export const FloatingWhatsApp: React.FC = () => {
  ...
  const whatsappUrl = `https://wa.me/${siteContent.contact.whatsappRaw}?text=${encodeURIComponent(
    'Hola Serna Estate, deseo realizar una consulta legal inmobiliaria.'
  )}`;
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 select-none">
      ...
      <a
        ...
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
        className="relative group p-3.5 sm:p-4 rounded-full bg-[#25D366] text-white shadow-2xl hover:bg-[#20ba5a] transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-[#25D366]/40 flex items-center justify-center min-w-[56px] min-h-[56px]"
        aria-label="Abrir chat de WhatsApp con Serna Estate"
      >
        {/* Glow Ring */}
