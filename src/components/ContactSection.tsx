    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 bg-[#F8FAF9] rounded-xl border border-[#014937]/20 p-6 sm:p-8 md:p-10 shadow-lg relative">
            ...
            {formSubmitted ? (
              <div className="bg-white rounded-lg border-2 border-[#014937] p-6 sm:p-8 space-y-6 text-left animate-in fade-in duration-300">
                ...
                <button
                  ...
                  className="text-xs font-heading text-[#AE7E25] underline hover:text-[#014937] block pt-2"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="pt-3">
                  <button
                    type="submit"
                    className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#014937] text-white font-heading font-bold text-sm uppercase tracking-wider rounded-md hover:bg-[#146A55] transition-all shadow-md focus:ring-2 focus:ring-[#E0BB5D]"
                  >
            ...
            <div className="p-6 bg-gradient-to-br from-[#014937] to-[#146A55] text-white rounded-xl shadow-md border-t-4 border-[#E0BB5D] space-y-4">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 pt-1">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-3 bg-white/10 hover:bg-white/20 text-white font-heading font-medium text-xs rounded transition-colors flex items-center justify-center gap-1.5"
                >
            ...
            <div className="p-6 bg-[#F8FAF9] rounded-xl border border-[#014937]/20 shadow-sm space-y-4">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-3 bg-white hover:bg-[#F1F5F3] border border-[#014937]/20 text-[#014937] font-heading font-medium text-xs rounded transition-colors flex items-center justify-center gap-1.5"
                >
